module.exports = function(__fest_context) {
    ...
    __v2 = {
        ...
        attrs: {
            ...
            "data-value": "current is: " + __fest_attrs[0] + ""
        }
    };
    __v1.children.push(__v2);
    __v2.children = __v2.children || [];
    ...
    if (__fest_if) {
        ...
        __v1.children.push(__v2);
        var i, todo, __fest_to0, __fest_iterator0;
        try {
            __fest_iterator0 = json.todos || [];
        ...
        for (i = 0; i < __fest_to0; i++) {
            ...
            __v2.children.push(__v3);
            try {
                __fest_attrs[0] = __fest_string(todo.id)
            } catch (e) {
                __fest_attrs[0] = "";
                __fest_log_error(e.message);
            }
            ...
            __v4.children.push(__v5);
            __v5.children = __v5.children || [];
            var __v6 = {
                tag: "input",
                attrs: {
                    "type": "checkbox"
            ...
            __v5.children.push(__v6);
            __v6 = {
                tag: "span"
            };
            __v5.children.push(__v6);
            try {
                __v6.children = __v6.children || [];
                __v6.children.push(__fest_string(todo.text))
            } catch (e) {
        ...
        __v1.children.push(__v2);
        __v2.children = __v2.children || [];
        __v2.children.push("Total todos:");
        try {
            __v2.children.push(__fest_string(json.todos.length))
        } catch (e) {
