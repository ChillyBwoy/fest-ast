...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c71 = function(first, last) { return first + last.join("") },
      peg$c72 = peg$otherExpectation("qualified identifier"),
      peg$c73 = ":",
      peg$c74 = peg$literalExpectation(":", false),
      peg$c75 = function(prefix, id) { return `${prefix}:${id}` },
      peg$c76 = function(id) { return id },
      peg$c77 = "<",
      peg$c78 = peg$literalExpectation("<", false),
      peg$c79 = function(type) { return true },
      peg$c80 = ">",
      peg$c81 = peg$literalExpectation(">", false),
      peg$c82 = function(type, attrs) { return true },
      peg$c83 = function(type, attrs) {
      ...
      peg$c89 = function(tag, content) { return content },
      peg$c90 = function(tag, contents) {
            tag.children = flat(tag.children.concat(contents));
            tag.children = mergeNodes(tag.children);

            return tag;
          },
      peg$c91 = function(tag) { return tag },
      peg$c92 = /^[^<\n\r]/,
      ...
      peg$c98 = function(identity, value) {
      ...
      peg$c104 = "<?xml",
      peg$c105 = peg$literalExpectation("<?xml", true),
      peg$c106 = "version",
      peg$c107 = peg$literalExpectation("version", true),
      peg$c108 = "encoding",
      peg$c109 = peg$literalExpectation("encoding", true),
      peg$c110 = "standalone",
      peg$c111 = peg$literalExpectation("standalone", true),
      peg$c112 = peg$otherExpectation("CDATA"),
      peg$c113 = "<![CDATA[",
      peg$c114 = peg$literalExpectation("<![CDATA[", false),
      peg$c115 = function(children) {
            return createNode('#cdata', {}, escapeContent(children));
          },
      peg$c116 = "]]>",
      peg$c117 = peg$literalExpectation("]]>", false),
      peg$c118 = function(head, tail) { return head + tail },
      peg$c119 = peg$otherExpectation("comment"),
      peg$c120 = "<!--",
      peg$c121 = peg$literalExpectation("<!--", false),
      peg$c122 = function(children) {
            return createNode('#comment', {}, escapeContent(children));
          },
      peg$c123 = "-->",
      peg$c124 = peg$literalExpectation("-->", false),
      peg$c125 = function() { return '' },
      peg$c126 = peg$otherExpectation("fest:text"),
      peg$c127 = "<fest:text>",
      peg$c128 = peg$literalExpectation("<fest:text>", false),
      peg$c129 = function(children) {
            return createNode('fest:text', {}, escapeContent(children));
          },
      peg$c130 = "</fest:text>",
      peg$c131 = peg$literalExpectation("</fest:text>", false),
      peg$c132 = peg$otherExpectation("fest:params"),
      peg$c133 = "<fest:params>",
      peg$c134 = peg$literalExpectation("<fest:params>", false),
      peg$c135 = function(content) {
      ...
      peg$c136 = "</fest:params>",
      peg$c137 = peg$literalExpectation("</fest:params>", false),
  ...
  function peg$parseElementContent() {
    ...
    s0 = peg$parseCdata();
    if (s0 === peg$FAILED) {
      s0 = peg$parseFestText();
      if (s0 === peg$FAILED) {
        s0 = peg$parseFestParams();
        if (s0 === peg$FAILED) {
          s0 = peg$parseComment();
          if (s0 === peg$FAILED) {
            s0 = peg$parseElement();
  ...
  function peg$parseFestTextContent() {
    var s0, s1, s2,
        startPos = peg$currPos;

    peg$tracer.trace({
      type:     "rule.enter",
      rule:     "FestTextContent",
      location: peg$computeLocation(startPos, startPos)
    });
  ...
  function peg$parseFestParamsContent() {
    var s0, s1, s2,
        startPos = peg$currPos;

    peg$tracer.trace({
      type:     "rule.enter",
      rule:     "FestParamsContent",
      location: peg$computeLocation(startPos, startPos)
    });
    ...
    // const { escapeJS, escapeHTML } = require('../utils/parser');
    // console.log(escapeSource);
